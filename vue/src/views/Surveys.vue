<template>
  <PageComponent>
    ...
    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3">
     ...
     hover:bg-gray-50
     h-[470px]">
        <img :src="survey.image" alt="Surveys Image" class="w-full h-48 object-cover shadow-md" />
        ...
        focus:ring-2 focus:ring-offset-2 focus:ring-primary">
          ...
          <button v-if="survey.id" type="button" @click="deleteSurvey(survey)"
            class="h-8 w-8 flex items-center justify-center rounded-full vorder border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors cursor-pointer hover:bg-[rgba(0,0,0,0.2)]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
