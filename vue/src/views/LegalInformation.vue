<template>
  <div class="bg-white shadow-md p-10 text-left flex flex-col mx-auto  max-w-7xl py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="my-4 flex">
      <div class="w-1/4">
        <p class="text-gray-700 font-medium">Responsable de la rédaction :</p>
      </div>
      <div class="w-3/4">
        <p class="text-gray-600">Mehdi Krouk</p>
      </div>
    </div>
    <div class="my-4 flex">
      <div class="w-1/4">
        <p class="text-gray-700 font-medium">Crédits :</p>
      </div>
      <div class="w-3/4">
        <p class="text-gray-600">Production et direction éditoriales : Mehdi Krouk</p>
        <p class="text-gray-600">Développement web : Mehdi Krouk</p>
        <p class="text-gray-600">Design : Mehdi Krouk</p>
      </div>
    </div>
    <div class="my-4 flex">
      <div class="w-1/4">
        <p class="text-gray-700 font-medium">Fournisseur d’hébergement :</p>
      </div>
      <div class="w-3/4">
    ...
    <div class="my-4 flex">
      <div class="w-1/4">
        <p class="text-gray-700 font-medium">Système de gestion de contenus :</p>
      </div>
      <div class="w-3/4">
        <p class="text-gray-600">LARAVEL / VUEJS</p>
      </div>
    </div>
    <div class="my-4 flex">
      <div class="w-1/4">
